...
% --- Coding launch files ---
\begin{frame}{Coding launch files}{Hints and best practices}
	\begin{itemize}
		...
		\item A module can have its own launch files but those for the entire architecture must form an appropriate \textbg{package}, whose name is usually \texttt{PROJECT\_bringup}.
	\end{itemize}
	\begin{block}{}
		\centering
